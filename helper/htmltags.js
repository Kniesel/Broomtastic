module.exports = {
	...
	'registerform':'<form action=\"/register\" method=\"post\" id=\"registerform\"><p>Username</p><input class=\"inputforms\" type=\"text\" name=\"username\"><br><p>Password</p><input class=\"inputforms\" type=\"password\" name=\"password\"><br><p>Enter password again</p><input class=\"inputforms\" type=\"password\" name=\"password2\"><br><p>E-Mail-Address (do not cheat, we will send you a registration e-mail!)</p><input class=\"inputforms\" type=\"text\" name=\"email\"><input class=\"inputforms\" type=\"submit\" value=\"Register\"></form>',
